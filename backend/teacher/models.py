...
#null= False ---> dado obrigatorio
#blank= False  ---> não branco
#decimal_places= 2  --> 2 casas decimais.

#ForeignKey --> chave estrangeira
    #to -->> relaciona com quem
    #on_delete --> O que fazer quando um Professor for excluido.
        #CASCADE --> deleta o professor e também as aulas.
